...
async function fetchGitHubRepos() {
    ...
    try {
        const response = await fetch('https://api.github.com/users/Ndebvushenko/repos');
        ...
        const fallbackProjects = [
            {
                name: 'Credit Risk Assessment Tool',
                description: 'Excel-based tool for evaluating borrower risk profiles and tracking repayment schedules with early warning indicators.',
                html_url: '#',
                language: 'Excel',
                stargazers_count: 8,
                forks_count: 2
            ...
            {
                name: 'ESG Risk Integration Framework',
                description: 'Research project on incorporating environmental, social, and governance factors into traditional credit risk assessment models.',
                html_url: '#',
                language: 'Research',
                stargazers_count: 12,
                forks_count: 4
            ...
            {
                name: 'Financial Training Materials',
                description: 'Comprehensive training materials for financial services professionals covering wealth management, insurance, and regulatory frameworks.',
                html_url: '#',
